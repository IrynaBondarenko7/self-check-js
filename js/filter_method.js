...
//2) У змінній topRatedBooks утворився масив книг,
...
//3)щоб function повертала масив користувачів,
...
//4)щоб вона повертала масив користувачів, вік яких (властивість age) потрапляє у проміжок від minAge до maxAge.
...
//     40
//   )
// );// масив об'єктів користувачів з іменами `Moore Hensley`, `Sharlene Bush`, `Blackburn Dotson` і `Sheree Anthony`

//5)щоб вона повертала масив користувачів, у яких є один з ім'ям в параметрі friendName.
...
// //або users.filter((user) => user.friends.includes(friendName));
// console.log(getUsersWithFriend(users, "Goldie Gentry"));

//6)
//щоб вона повертала масив друзів всіх користувачів (властивість friends).
//У декількох користувачів можуть бути однакові друзі, зроби так, щоб масив,
